...
- Decision scope: STT model roles before approved pilot/customer-pilot WER evidence is available
...
privacy-safe approved pilot/customer-pilot meeting. Common Voice data is ready,
but the real pilot recording requires operator approval, participant consent,
...
Until the approved pilot/customer-pilot dataset and #35/#36 measurements are available:
...
- approved pilot/customer-pilot WER/CER after explicit consent;
...
- #34 real pilot/customer-pilot recording is operator-action;
...
pilot recording and reviewed ground truth become available.
...
- development can continue without pretending the pilot WER dataset exists;
