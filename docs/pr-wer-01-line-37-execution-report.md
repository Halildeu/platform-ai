...
Record a technically honest STT model decision while the real ERP/CRM pilot
...
## Pilot Recording Blocker

A real ERP/CRM pilot meeting recording cannot currently be performed. Therefore:

- #35 and #36 were temporarily skipped, not completed;
- no ERP/CRM pilot WER, CER, latency, accuracy, or model-comparison result is
  claimed;
- #37 uses only the models and observations already tested in the PoC;
- the decision remains `PROVISIONAL`;
- the project must return to #35 and #36 after an approved ERP/CRM pilot recording,
  participant consent, encrypted storage, manual ground truth, and review are
  available.

This deferral prevents the missing ERP/CRM pilot test from blocking all subsequent
...
- ERP/CRM pilot recording cannot currently be performed.
...
|---|---|---|
| Pilot-domain accuracy unknown | ERP/CRM vocabulary may perform worse | ADR reopen required after #34/#35 |
