...
| **Platform ekosistem reuse** | Standalone publish YOK; auth/notification/audit/permission reuse zorunlu; cross-repo contract drift yasak; Workcube yalnız pilot/adapter örneği olabilir |
