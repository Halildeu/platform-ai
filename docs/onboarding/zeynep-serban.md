...
| **Platform ekosistem reuse** | Standalone publish YOK; auth/notification/audit/permission reuse zorunlu; cross-repo contract drift yasak; pilot müşteri/adaptör örnekleri core kontrata gömülemez |
