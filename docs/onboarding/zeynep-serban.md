...
| **Platform ekosistem reuse** | Standalone publish YOK; auth/notification/audit/permission reuse zorunlu; cross-repo contract drift yasak; ERP/CRM vendor adı ürün kontratı değildir |
